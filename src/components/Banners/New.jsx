  ...
  return (
    <div className="">
      ...
      <h2 className="text-lg font-semibold flex items-center gap-2">
                      <img onClick={() => navigate('/dashboard/banners/social')} src={nrk} className="cursor-pointer"></img> Add New Social Links
      </h2>
      ...
      <div className="bg-white rounded-xl shadow p-6 mt-4">
        <div className="flex gap-6">
          ...
          <div className="flex-1 space-y-4">
            ...
            {/* Link Address */}
            <div>
              <label className="block text-sm font-medium mb-1">Link Address</label>
              <input
                type="text"
