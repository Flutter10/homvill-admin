      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="relative w-[720px] rounded-2xl bg-white p-5">
            ...
            <button
              onClick={handleClose}
              className="absolute right-4 top-3 text-xl leading-none text-gray-500 hover:text-gray-700"
              aria-label="Close"
            >
              ×
            </button>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 space-y-3">
                ...
                <textarea
                  ...
                  className="h-28 w-full resize-none rounded-lg border px-3 py-2 outline-none focus:ring-2 focus:ring-[#8B1C32]/40"
                />
              </div>
            </div>
