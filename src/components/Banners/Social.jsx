    ...
    return (
        <div className="">
            ...
            <h2 className="text-lg font-semibold flex items-center gap-2">
                <img onClick={() => navigate('/dashboard/banners')} src={nrk} className="cursor-pointer"></img> Social Links
            </h2>
            ...
            <div className="bg-[#F6F6F6] rounded-xl shadow p-6 mt-4">
                ...
                <div className="flex justify-end gap-2 items-center mb-4">
                              <img src={share}  onClick={() => setOpen(true)} className="text-xl cursor-pointer" />
