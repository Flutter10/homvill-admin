...
const Dashboard = () => {
  ...
  const newUsers = [
    { name: "Jenny Wilson", date: "Dec 18, 2024", email: "example@gmail.com", id: "7452031" },
    { name: "Albert Flores", date: "Dec 18, 2024", email: "example@gmail.com", id: "7452031" },
    { name: "Marvin McKinney", date: "Dec 18, 2024", email: "example@gmail.com", id: "7452031" },
    { name: "Sharyn Haney", date: "Dec 18, 2024", email: "example@gmail.com", id: "7452031" },
  ];
  const chartOptions = {
    responsive: true,
  ...
  <span className="text-green-500 text-sm flex items-center gap-1">
    ▲ 201
          ...
          <div className="bg-white shadow rounded-xl border border-[#8A1538] p-4">
            ...
            <div className="h-[380px]"> {/* taller to match left height */}
