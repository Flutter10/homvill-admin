...
export default function Subscriptions() {
  ...
  hover:bg-[#8A1538] hover:text-white transition-colors duration-200">
                ...
                <button onClick={() => navigate('/dashboard/subscribe/active')} className="px-4 py-2 bg-[#8A1538] text-white rounded-md text-sm font-medium shadow">
            ...
            <div className="overflow-x-auto">
                <table className="w-full border-collapse rounded-lg overflow-hidden text-sm">
                    ...
                    <tbody>
                        {[
                            { name: "Basic", price: "$199 / mo", features: "03", sub: "Buyer", color: "text-[#8CAC0C]" },
                            { name: "Gold", price: "$499 / mo", features: "08", sub: "Buyer", color: "text-[#8CAC0C]" },
                            { name: "Premium", price: "$999 / mo", features: "15", sub: "Buyer", color: "text-[#8CAC0C]" },
                            { name: "Basic", price: "$199 / mo", features: "03", sub: "Seller", color: "text-[#001381]" },
                            { name: "Gold", price: "$499 / mo", features: "08", sub: "Seller", color: "text-[#001381]" },
                            { name: "Premium", price: "$999 / mo", features: "15", sub: "Seller", color: "text-[#001381]" },
                            { name: "Basic", price: "$199 / mo", features: "03", sub: "Contractor", color: "text-[#970076]" },
                            { name: "Gold", price: "$599 / mo", features: "07", sub: "Contractor", color: "text-[#970076]" },
                        ].map((item, i) => (
                            <tr key={i} className="border-b  hover:bg-gray-50">
                                <td
                                    className="px-4 py-2 text-gray-800 border-r font-medium"
                                    style={{
                                        background: "linear-gradient(241.96deg, #FF6794 -7.86%, #FFE6EE 62.28%, #FFFFFF 132.41%)",
                                    }}
                                >
                                    {item.name}
                                </td>
