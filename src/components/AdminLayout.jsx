...
const menuItems = [
  ...
  { label: "Audit Log", path: "/dashboard/audit-log", icon: <FaCogs /> },
  { label: "Add Sub Admin", path: "/dashboard/add-subadmin", icon: <FaPlus /> },
                      ...
                      >
                        ...
                        <div className="flex-grow">
                          <p className="text-sm text-gray-800 font-medium">
                            <span className="font-bold">John Doe</span> has raised a concern.
                          </p>
                          <p className="text-xs text-gray-500 mt-1">March 16, 2025 &nbsp; 2:33 pm</p>
                        </div>
