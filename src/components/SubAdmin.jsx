...
const AddSubAdmin = () => {
  const employees = [
    { id: "EMP12423", name: "Tiana Curtis", image: "https://via.placeholder.com/40" },
    { id: "EMP12423", name: "Justin Donin", image: "https://via.placeholder.com/40" },
    { id: "EMP12423", name: "Talan Saris", image: "https://via.placeholder.com/40" },
    { id: "EMP12423", name: "Alfonso Botosh", image: "https://via.placeholder.com/40" },
    { id: "EMP12423", name: "Maria Curtis", image: "https://via.placeholder.com/40" },
    { id: "EMP12423", name: "Talan Kentor", image: "https://via.placeholder.com/40" },
  ];
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-500 mb-4">
        Monitor any changes made to your project, view them and connect with audit logs.
      </p>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-green-600">Employee ID: {emp.id}</p>
                </div>
              </div>
