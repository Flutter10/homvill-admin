...
const LoginPage = () => {
    ...
    <div style={{fontFamily:'Poppins'}} className="w-1/2 flex flex-col justify-center px-24 bg-white rounded-tl-2xl rounded-bl-2xl shadow-lg">
        ...
        <h2  className="text-[26px] text-center text-[#000000] font-semibold mb-6">Register Here</h2>
        ...
        {/* Password */}
        <label className="block text-[20px] text-[#7C838A] mb-1">Password</label>
        <input
            type="password"
            placeholder="Enter your Password here"
            className="w-full mb-4 px-4 py-3 rounded-xl border border-gray-300 bg-[#B0BAC340] rounded-lg text-sm "
        />
         <label className="block text-[20px] text-[#7C838A] mb-1">Confirm Password</label>
        <input
            type="password"
        ...
        {/* Register */}
          <div className="flex justify-center">
        <button  onClick={() => navigate("/")}className="w-[340px] border border-pink-300 text-[#a70f3a] py-2 rounded-lg font-medium hover:bg-pink-50">
            Login Now
        </button></div>
    </div>
</div>
