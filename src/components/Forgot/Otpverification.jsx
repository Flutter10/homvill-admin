...
import houseImage from "../../components/assets/group2.svg"; // replace with your left image
...
>
  ...
  <p className="text-center text-sm text-gray-500 mb-6">
    ...
    <span className="text-[#8A1538] font-medium">example@gmail.com</span> to
  ...
  {/* Continue Button */}
  <button     onClick={() => navigate("/newpassword")} className="w-[340px] bg-[#8A1538] text-white py-2 rounded-lg font-medium text-[18px]">
    Continue
  </button>
</div>
