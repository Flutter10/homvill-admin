...
const CreatePromoCode = () => {
  ...
  const navigate = useNavigate();
    ...
    return (
        <div className=" ">
            {/* Header */}
            {/* <h2 className="text-xl font-semibold mb-2">Create A Promo Code</h2> */}
             <div className="flex items-center gap-2 mb-6">
                <ArrowLeft   onClick={() => navigate('/dashboard/promocode')} size={20} className="cursor-pointer" />
                <h1 className="text-lg font-semibold">Create A Promo Code</h1>
            </div>
            <p className="text-sm text-gray-500 mb-6">
                Learn ipsum is simply dummy text of the printing and typesetting industry.
            </p>
                ...
                <div>
                    ...
                    <div className="flex items-center gap-4">
                        <label className="flex items-center gap-2 text-sm">
                            <input type="radio" name="type" /> Public Coupon
                        </label>
                        <label className="flex items-center gap-2 text-sm">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-4">
                        <span className="text-xs text-gray-500">
                            Toggle OFF, in case you don’t want to show this coupon to your users.
                        </span>
...
<br/>
                ...
                <div>
                 ...
                 <div className="mt-6 items-center flex justify-end">
