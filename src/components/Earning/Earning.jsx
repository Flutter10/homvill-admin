        ...
        <div className="">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center  gap-4">
                    ...
                    <div className="flex flex-wrap  items-center gap-3">
                        <div className="border shadow-md ml-4 border-gray-300 bg-white text-[#8A1538] font-semibold text-sm px-4 py-2 rounded-md">
                            Total Earnings: <span className="text-[#8A1538]">$100,000,000.00</span>
                        </div>
                        ...
                        <button className="border px-4 py-2 shadow-md ml-2  rounded-md text-sm">Download</button>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mt-4 text-sm">
                <p>
                    ...
                    {Math.min(startIndex + entriesPerPage, data.length)} of {data.length} entries
                </p>
